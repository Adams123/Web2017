...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ProductDetail = __webpack_require__(252);

	var _ProductDetail2 = _interopRequireDefault(_ProductDetail);

	var _Services = __webpack_require__(253);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouter.Route, { path: '/products/:id', component: _ProductDetail2.default })
	    ),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this._getLogin = _this._getLogin.bind(_this);
	  ...
	  _createClass(App, [{
	    ...
	    value: function handleSubmit(event) {
	      ...
	      var users = [];
	      _axios2.default.get("/api/login").then(function (response) {
	        var _iteratorNormalCompletion = true;
	        var _didIteratorError = false;
	        var _iteratorError = undefined;

	        try {
	          for (var _iterator = response['data']['users'][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var u = _step.value;
	        ...
	        try {
	          for (var _iterator2 = users[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	            ...
	            if (user['login'] == userName && user['password'] == pwd) _this2.setState({
	              logged: true
	            });
	          }
	        } catch (err) {
	    ...
	    value: function isLogged() {
	      if (!this.state.logged) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'form',
	            { id: 'form-login', onSubmit: this.handleSubmit },
	            _react2.default.createElement(
	              'label',
	              null,
	              'Login:'
	            ...
	            _react2.default.createElement(
	              'button',
	              { className: 'submits', id: 'loginButton', type: 'submit' },
	              'Entrar'
	            )
	          )
	        );
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'p',
	            null,
	            'Bem-vindo ao Petchoop! O Melhor petshop da web!'
	          )
	        );
	      }
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Products = function (_React$Component) {
	  ...
	  function Products(props) {
	    ...
	    _this._showNewProductForm = _this._showNewProductForm.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Products, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      _axios2.default.get("/api/products").then(function (response) {
	        ...
	        try {
	          for (var _iterator = response['data']['products'][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var p = _step.value;
	    ...
	    value: function handleSubmit(event) {
	      event.preventDefault();
	      var id = event.target.elements[0].value;
	      var path = '/products/' + id;
	      this.context.router.push(path);
	    }
	  }, {
	    key: '_handleProducts',
	    value: function _handleProducts() {
	      var prods = [];
	      var _iteratorNormalCompletion2 = true;
	      var _didIteratorError2 = false;
	      var _iteratorError2 = undefined;
	      ...
	      try {
	        for (var _iterator2 = this.state.products[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          ...
	          prods.push(_react2.default.createElement(_Product2.default, { id: prod['id'],
	            name: prod['name'],
	            stock: prod['stock'],
	            price: prod['price'],
	            sold: prod['sold'],
	    ...
	    key: '_showNewProductForm',
	    value: function _showNewProductForm() {
	      this.setState({ show: false, create: true });
	    }
	  }, {
	    key: '_handleNewProduct',
	    value: function _handleNewProduct(event) {
	      event.preventDefault();
	      var name = event.target.elements[0].value;
	      var description = event.target.elements[1].value;
	      var price = event.target.elements[2].value;
	      var stock = event.target.elements[3].value;
	      var sold = event.target.elements[4].value;
	    ...
	    value: function render() {
	      ...
	      if (this.state.show) {
	        container = _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: this._showNewProductForm, className: 'new-product-button' },
	            'Novo Produto'
	          ),
	        ...
	        container = _react2.default.createElement(
	          'form',
	          { id: 'form-new-product', onSubmit: this._handleNewProduct },
	          _react2.default.createElement(
	            'ul',
	            null,
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'text', placeholder: 'Nome do Produto' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'text', placeholder: 'Descri\xE7\xE3o' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'number', placeholder: 'Pre\xE7o' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'number', placeholder: 'Quantidade em estoque' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'number', placeholder: 'Quantidade vendida' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'button',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Products = function (_React$Component) {
	  ...
	  _createClass(Products, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var path = '/api/products/' + this.props.id;
	      var prods = [];
	      _axios2.default.get(path).then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Service = __webpack_require__(254);
	...
	var Services = function (_React$Component) {
	  ...
	  function Services(props) {
	    ...
	    _this._showNewServiceForm = _this._showNewServiceForm.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Services, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var prods = [];
	      _axios2.default.get("/api/services").then(function (response) {
	        var _iteratorNormalCompletion = true;
	        var _didIteratorError = false;
	        var _iteratorError = undefined;

	        try {
	          for (var _iterator = response['data']['services'][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            var p = _step.value;
	    ...
	    key: '_handleServices',
	    value: function _handleServices() {
	      var prods = [];
	      var _iteratorNormalCompletion2 = true;
	      var _didIteratorError2 = false;
	      var _iteratorError2 = undefined;
	      ...
	      try {
	        for (var _iterator2 = this.state.services[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	          var prod = _step2.value;

	          prods.push(_react2.default.createElement(_Service2.default, { id: prod['id'],
	            name: prod['name'],
	            price: prod['price'],
	            description: prod['description']
	          }));
	    ...
	    key: '_showNewServiceForm',
	    value: function _showNewServiceForm() {
	      this.setState({ show: false, create: true });
	    }
	  }, {
	    key: '_handleNewService',
	    value: function _handleNewService(event) {
	      event.preventDefault();
	      var name = event.target.elements[0].value;
	      var description = event.target.elements[1].value;
	      var price = event.target.elements[2].value;
	      _axios2.default.post('/api/services', {
	        name: name,
	        description: description,
	        price: price
	      }).then(function (response) {
	    ...
	    value: function render() {
	      ...
	      if (this.state.show) {
	        ...
	        container = _react2.default.createElement(
	          'form',
	          { id: 'form-new-product', onSubmit: this._handleNewService },
	          _react2.default.createElement(
	            'ul',
	            null,
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'text', placeholder: 'Nome do Servi\xE7o' }),
	              ' '
	            ),
	            _react2.default.createElement(
	              'li',
